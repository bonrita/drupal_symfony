 ...
 */
final class Version20181206175659 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE task (id INT AUTO_INCREMENT NOT NULL, project_id INT DEFAULT NULL, title VARCHAR(45) NOT NULL, description TINYTEXT DEFAULT NULL, due_date DATETIME DEFAULT CURRENT_TIMESTAMP, INDEX task_project_idx (project_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE project (id INT AUTO_INCREMENT NOT NULL, workspace_id INT DEFAULT NULL, title VARCHAR(45) DEFAULT \'NULL\' NOT NULL, description TINYTEXT DEFAULT NULL, due_date DATETIME DEFAULT \'NULL\', INDEX fk_workspace_idx (workspace_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE app_roles (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, permissions LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:simple_array)\', description VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_60EDA30A5E237E06 (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
